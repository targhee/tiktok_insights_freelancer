...
ACTIVE_PRODUCTS = [
    ProductMetadata(
        stripe_id='prod_N4FuUOXjuBI1Ha',
        slug='tiktok-insights-subscription-plan',
        name='TikTok Insights Subscription Plan',
        features=[
            _('Guided Ranking Advice'),
            _('Weekly Ranking Chart'),
            _('Current TikTok Stats')],
        price_displays={},
        description='The TikTok Insights Subscription Plan plan',
        is_default=True),
]
